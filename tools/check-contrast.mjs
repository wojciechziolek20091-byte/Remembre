...
const PAIRS = [
  ...
  ["--ink", "--s-economics-soft", 4.5, "lesson text on the Economics tint"],
  ["--ink", "--s-mathematics-soft", 4.5, "lesson text on the Mathematics tint"],
  ["--ink", "--s-english-soft", 4.5, "lesson text on the English tint"],
  ["--ink", "--s-polish-soft", 4.5, "lesson text on the Polish tint"],
  ["--ink", "--s-history-soft", 4.5, "lesson text on the History tint"],
  ["--ink", "--s-ess-soft", 4.5, "lesson text on the ESS tint"],
  ["--ink", "--s-none-soft", 4.5, "lesson text on the neutral tint"],
  ["--ink-2", "--s-economics-soft", 4.5, "room number on the Economics tint"],
  ["--ink-2", "--s-mathematics-soft", 4.5, "room number on the Mathematics tint"],
  ["--ink-2", "--s-english-soft", 4.5, "room number on the English tint"],
  ["--ink-2", "--s-polish-soft", 4.5, "room number on the Polish tint"],
  ["--ink-2", "--s-history-soft", 4.5, "room number on the History tint"],
  ["--ink-2", "--s-ess-soft", 4.5, "room number on the ESS tint"],
